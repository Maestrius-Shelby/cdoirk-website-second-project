...
<div id="wrapper" class="wrapper">
			...
			<div class="itc-slider-wrapper">
			  <div class="itc-slider-items">
				...
				<div class="itc-slider-item">
					<picture>
					  <source srcset="images/SSUWT/comp.jpg" type="image/jpeg" media="(min-width:970px)">
					  <source srcset="images/SSUWT/comp.jpg" type="image/jpeg" media="(min-width:750px)">
					  <source srcset="images/SSUWT/comp.jpg" type="image/jpeg" media="(max-width:750px)">
					  <img src="images/SSUWT/comp.jpg">
					</picture>
					...
					<div class="container no-padding">
						<div class="hs-caption">
							...
							<br>
								<h4>КОМПЬЮТЕРНАЯ ГРАМОТНОСТЬ ДЛЯ НАЧИНАЮЩИХ</h4>
	...
	<section id="service" class="service">
		...
		<div class="about_welcome_4 wow circle animate__zoomInDown bvi-speech">
			<div class="row">
				<h2>КОМПЬЮТЕРНАЯ ГРАМОТНОСТЬ</h2><br><br>
				<div>
					<p>
						Программа предполагает ознакомление слушателей с пакетом программ Microsoft Offce, с основами безопасной работы в интернете, 
						а также с процессом получения электронных услуг через интернет. Цель программы — обучение лиц старшего возраста первичным навыкам работы 
						с персональным компьютером, с целью преодоления проблемы включения их в современную информационную среду.	
					</p>
					<ul>
						<li>
							<b>Категория слушателей:</b> лица старшего возраста.
						</li>
