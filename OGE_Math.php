			...
			<div class="itc-slider-wrapper">
			  <div class="itc-slider-items">
				...
				<div class="itc-slider-item">
					<picture>
					  <source srcset="images/SSUWT/math.jpg" type="image/jpeg" media="(min-width:970px)">
					  <source srcset="images/SSUWT/math.jpg" type="image/jpeg" media="(min-width:750px)">
					  <source srcset="images/SSUWT/math.jpg" type="image/jpeg" media="(max-width:750px)">
					  <img src="images/SSUWT/math.jpg">
					</picture>
					...
					<div class="container no-padding">
						<div class="hs-caption">
							...
							<br>
								<h4>ПОДГОТОВКА К ОГЭ ПО ПРЕДМЕТУ: МАТЕМАТИКА</h4>
	...
	<section id="service" class="service">
		...
		<div class="about_welcome_4 wow circle animate__zoomInDown bvi-speech">
			<div class="row">
				...
				<div>
					<p>
						Рабочая программа составлена на основе Методических рекомендаций ФИПИ, анализа типичных ошибок участников ОГЭ 2023 года по математике, 
						Методических рекомендаций на 2023-2024 учебный год, Демонстрационного варианта КИМ ОГЭ по математике 2024 года, Кодификатора элементов 
						содержания и Спецификации КИМ. Цель обучения – повышение уровня предметной подготовки обучающихся по математике; успешная сдача ОГЭ.
					</p>
					<ul>
						<li>
