...
<footer id="footer2">
	<div class="container bvi-speech wow circle fadeInUpBig">
		<div class="row">
			<div class="col-md-3">
				<h3>Контакты</h3>
				<div class="fcontact">
			...
			<div class="col-md-3">
				...
				<ul class="f-news">
					<li><a class="js-open-modal" data-modal="5">Новости<i class="fa fa-angle-right"></i></a></li>
					<li><a class="js-open-modal" data-modal="6">Заказать звонок<i class="fa fa-angle-right"></i></a></li>
					<li><a href="#">Отзывы<i class="fa fa-angle-right"></i></a></li>
