...
<div id="wrapper" class="wrapper">
			...
			<div class="itc-slider-wrapper">
			  <div class="itc-slider-items">
				...
				<div class="itc-slider-item">
					<picture>
					  <source srcset="images/SSUWT/russian.jpg" type="image/jpeg" media="(min-width:970px)">
					  <source srcset="images/SSUWT/russian.jpg" type="image/jpeg" media="(min-width:750px)">
					  <source srcset="images/SSUWT/russian.jpg" type="image/jpeg" media="(max-width:750px)">
					  <img src="images/SSUWT/russian.jpg">
					</picture>
					...
					<div class="container no-padding">
						<div class="hs-caption">
							...
							<br>
								<h4>ПОДГОТОВКА К ОГЭ ПО ПРЕДМЕТУ: РУССКИЙ ЯЗЫК</h4>
	...
	<section id="service" class="service">
		...
		<div class="about_welcome_4 wow circle animate__zoomInDown bvi-speech">
			<div class="row">
				<h2>Подготовка к ОГЭ</h2><br><br>
				<div>
					<p>
						Рабочая программа составлена на основе Методических рекомендаций ФИПИ, анализа типичных ошибок участников ОГЭ 2023 года по русскому языку, 
						Методических рекомендаций на 2023-2024 учебный год, Демонстрационного варианта КИМ ОГЭ по русскому языку 2024 года, Кодификатора элементов 
						содержания и Спецификации КИМ. Цель обучения – повышение уровня предметной подготовки обучающихся по русскому языку; успешная сдача ОГЭ.
					</p>
					<ul>
						<li>
							<b>Категория слушателей:</b> обучающиеся 8-9 классов.
						</li>
