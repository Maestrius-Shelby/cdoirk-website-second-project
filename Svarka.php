...
<div id="wrapper" class="wrapper">
				...
				<div class="itc-slider-item">
					...
					<div class="container no-padding">
						<div class="hs-caption">
							...
							<br>
								<h4>ОБОРУДОВАНИЕ И ТЕХНОЛОГИЯ СВАРОЧНОГО ПРОИЗВОДСТВА</h4>
								<p>Срок обучения: 1 неделя (16 часов)
	...
	<section id="service" class="service">
		...
		<div class="about_welcome_4 wow circle animate__zoomInDown bvi-speech">
			<div class="row">
				<h2>ОБОРУДОВАНИЕ И ТЕХНОЛОГИЯ СВАРОЧНОГО ПРОИЗВОДСТВА</h2><br><br>
				<div>
					<ul>
						<li>
						...
						<li>
							<b>Срок обучения:</b> 1 неделя (16 часов).<br>							
							Выдаваемый документ: удостоверение о повышении квалификации.<br>
						</li>
						<li>
