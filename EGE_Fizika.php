			...
			<div class="itc-slider-wrapper">
			  <div class="itc-slider-items">
				...
				<div class="itc-slider-item">
					<picture>
					  <source srcset="images/SSUWT/phicics.jpg" type="image/jpeg" media="(min-width:970px)">
					  <source srcset="images/SSUWT/phicics.jpg" type="image/jpeg" media="(min-width:750px)">
					  <source srcset="images/SSUWT/phicics.jpg" type="image/jpeg" media="(max-width:750px)">
					  <img src="images/SSUWT/phicics.jpg">
					</picture>
					...
					<div class="container no-padding">
						<div class="hs-caption">
							...
							<br>
								<h4>ПОДГОТОВКА К ЕГЭ ПО ПРЕДМЕТУ: ФИЗИКА</h4>
	...
	<section id="service" class="service">
		...
		<div class="about_welcome_4 wow circle animate__zoomInDown bvi-speech">
			<div class="row">
				...
				<div>
					<p>
						Рабочая программа составлена на основе Методических рекомендаций ФИПИ, анализа типичных ошибок участников ЕГЭ 2023 года по физике, 
						Методических рекомендаций на 2023-2024 учебный год, Демонстрационного варианта КИМ ЕГЭ по физике 2024 года, Кодификатора элементов 
						содержания и Спецификации КИМ. Цель обучения – повышение уровня предметной подготовки обучающихся по физике успешная сдача ЕГЭ.
					</p>
					<ul>
						<li>
