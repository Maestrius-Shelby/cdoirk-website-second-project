...
<head>
	...
	<title>От журналистики к блогерству</title>
...
<div id="wrapper" class="wrapper">
			...
			<div class="itc-slider-wrapper">
			  <div class="itc-slider-items">
				...
				<div class="itc-slider-item">
					<picture>
					  <source srcset="images/SSUWT/journal.jpg" type="image/jpeg" media="(min-width:970px)">
					  <source srcset="images/SSUWT/journal.jpg" type="image/jpeg" media="(min-width:750px)">
					  <source srcset="images/SSUWT/journal.jpg" type="image/jpeg" media="(max-width:750px)">
					  <img src="images/SSUWT/journal.jpg">
					</picture>
					...
					<div class="container no-padding">
						<div class="hs-caption">
							...
							<br>
								<h4>ОТ ЖУРНАЛИСТИКИ К БЛОГЕРСТВУ</h4>
								<p>Срок обучения: 4 месяца (16 часов)
								Стоимость: 2.000 руб. в месяц
								Дата начала обучения: будет объявлена позже
	...
	<section id="service" class="service">
		...
		<div class="about_welcome_4 wow circle animate__zoomInDown bvi-speech">
			<div class="row">
				<h2>ОТ ЖУРНАЛИСТИКИ К БЛОГЕРСТВУ</h2><br><br>
				<div>
					<p>
						Программа способствует развитию устной и письменной речи обучающихся, формированию информационной и правовой культуры, 
						овладению современными методами и формами цифровой коммуникации. Цель программы — формирование у обучающихся системы знаний 
						о современных средствах массовой информации, а также практических навыков в сфере различных интернет-публикаций.
					</p>
					<ul>
						<li>
							<b>Категория слушателей:</b> обучающиеся 8-11 классов.
						</li>
						...
						<li>
							<b>Формы обучения:</b> очная.<br>
						</li>
						<li>
							<b>Срок обучения:</b> 4 месяца (16 часов).<br>							
						...
						<li>
							<b>Дата начала обучения: </b> будет объявлена позже.<br>
						</li>
					</ul>
				</div>
			</div>
