...
<head>
	...
	<title>ОГЭ Информатика и ИКТ</title>
				...
				<div class="itc-slider-item">
					...
					<div class="container no-padding">
						<div class="hs-caption">
							...
							<br>
								<h4>ПОДГОТОВКА К ОГЭ ПО ПРЕДМЕТУ: ИНФОРМАТИКА И ИКТ</h4>
	...
	<section id="service" class="service">
		...
		<div class="about_welcome_4 wow circle animate__zoomInDown bvi-speech">
			<div class="row">
				...
				<div>
					<p>
						Рабочая программа составлена на основе Методических рекомендаций ФИПИ, анализа типичных ошибок участников ОГЭ 2023 года по информатике 
						и ИКТ Методических рекомендаций на 2023-2024 учебный год, Демонстрационного варианта КИМ ОГЭ по информатике и ИКТ 2024 года, Кодификатора 
						элементов содержания и Спецификации КИМ. Цель обучения – повышение уровня предметной подготовки обучающихся по информатике и ИКТ; успешная сдача ОГЭ
					</p>
					<ul>
						<li>
