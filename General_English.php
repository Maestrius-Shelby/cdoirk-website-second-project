...
<div id="wrapper" class="wrapper">
			...
			<div class="itc-slider-wrapper">
			  <div class="itc-slider-items">
				...
				<div class="itc-slider-item">
					<picture>
					  <source srcset="images/SSUWT/english.jpg" type="image/jpeg" media="(min-width:970px)">
					  <source srcset="images/SSUWT/english.jpg" type="image/jpeg" media="(min-width:750px)">
					  <source srcset="images/SSUWT/english.jpg" type="image/jpeg" media="(max-width:750px)">
					  <img src="images/SSUWT/english.jpg">
					</picture>
					...
					<div class="container no-padding">
						<div class="hs-caption">
							...
							<br>
								<h4>ОБЩИЙ АНГЛИЙСКИЙ</h4>
								<p>Срок обучения: 2 семестра (215 часов)
								Стоимость: 2.000 руб. в месяц
								Дата начала обучения: октябрь 2023 (Идет набор)
	...
	<section id="service" class="service">
		...
		<div class="about_welcome_4 wow circle animate__zoomInDown bvi-speech">
			<div class="row">
				<h2>ОБЩИЙ АНГЛИЙСКИЙ</h2><br><br>
				<div>
					<p>
						Курс направлен на формирование и систематизацию знаний и навыков коммуникации на английском языке у студентов с минимальным уровнем владения иностранным языком.
						Занятия рассчитаны на 2 семестра обучения и предусматривают освоение актуальных тем повседневной и профессиональной областей в виде аудирования, чтения, говорения, письма. 
						Курс предусматривает аудиторную (очные занятия с преподавателем) и самостоятельную работу (выполнение интерактивных заданий онлайн). 
						По завершению курса студенты проходят аттестацию в виде тестирования, на основание которого выдается сертификат, подтверждающий владение иностранным языком на начальном (базовом) уровне Beginner A1.
					</p>
					<p>
						<b>Цель программы —</b> формирование у студентов навыков ведения коммуникации в устной и письменной форме на английском языке, 
						а также формирование академических навыков, необходимых для использования английского языка в учебной деятельности и дальнейшем обучении в бакалавриате.
					</p>
					<ul>
						<li>
							<b>Категория слушателей:</b> студенты/курсанты первого года обучения.
						</li>

						<li>
							<b>Форматы обучения:</b>групповая работа.
						</li>
						<li>
						...
						<li>
							<b>Срок обучения:</b> 2 семестра (216 часов).<br>							
							Выдаваемый документ: сертификат.<br>
						</li>
						<li>
						...
						<li>
							<b>Дата начала обучения: </b> октябрь 2023 г.<br>
						</li>
					</ul>
				</div>
			</div>
