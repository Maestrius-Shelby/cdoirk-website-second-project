			...
			<div class="itc-slider-wrapper">
			  <div class="itc-slider-items">
				...
				<div class="itc-slider-item">
					<picture>
					  <source srcset="images/SSUWT/obje.jpg" type="image/jpeg" media="(min-width:970px)">
					  <source srcset="images/SSUWT/obje.jpg" type="image/jpeg" media="(min-width:750px)">
					  <source srcset="images/SSUWT/obje.jpg" type="image/jpeg" media="(max-width:750px)">
					  <img src="images/SSUWT/obje.jpg">
					</picture>
					...
					<div class="container no-padding">
						<div class="hs-caption">
							...
							<br>
								<h4>ПОДГОТОВКА К ЕГЭ ПО ПРЕДМЕТУ: ОБЩЕСТВОЗНАНИЕ</h4>
	...
	<section id="service" class="service">
		...
		<div class="about_welcome_4 wow circle animate__zoomInDown bvi-speech">
			<div class="row">
				...
				<div>
					<p>
						Рабочая программа составлена на основе Методических рекомендаций ФИПИ, анализа типичных ошибок участников ЕГЭ 2023 года по обществознанию, 
						Методических рекомендаций на 2023-2024 учебный год, Демонстрационного варианта КИМ ЕГЭ по обществознанию 2024 года, Кодификатора элементов 
						содержания и Спецификации КИМ. Цель обучения – повышение уровня предметной подготовки обучающихся по обществознанию; успешная сдача ЕГЭ.
					</p>
					<ul>
						<li>
