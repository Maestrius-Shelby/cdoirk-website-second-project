...
<head>
	...
	<title>Оборудование и технология сварочного производства</title>
...
<div id="wrapper" class="wrapper">
			...
			<div class="itc-slider-wrapper">
			  <div class="itc-slider-items">
				...
				<div class="itc-slider-item">
					<picture>
					  <source srcset="images/SSUWT/oge.jpg" type="image/jpeg" media="(min-width:970px)">
					  <source srcset="images/SSUWT/oge.jpg" type="image/jpeg" media="(min-width:750px)">
					  <source srcset="images/SSUWT/oge.jpg" type="image/jpeg" media="(max-width:750px)">
					  <img src="images/SSUWT/oge.jpg">
					</picture>
					...
					<div class="container no-padding">
						<div class="hs-caption">
							...
							<br>
								<h4>ПОДГОТОВКА, СБОРКА, СВАРКА И ЗАЧИСТКА ПОСЛЕ СВАРКИ СВАРНЫХ ШВОВ ЭЛЕМЕНТОВ КОНСТРУКЦИИ (ИЗДЕЛИЙ, УЗЛОВ, ДЕТАЛЕЙ)</h4>
								<p>Срок обучения: 256 часов
	...
	<section id="service" class="service">
		...
		<div class="about_welcome_4 wow circle animate__zoomInDown bvi-speech">
			<div class="row">
				<h2>ПОДГОТОВКА, СБОРКА, СВАРКА И ЗАЧИСТКА ПОСЛЕ СВАРКИ СВАРНЫХ ШВОВ ЭЛЕМЕНТОВ КОНСТРУКЦИИ (ИЗДЕЛИЙ, УЗЛОВ, ДЕТАЛЕЙ)</h2><br><br>
				<div>
					<ul>
						<li>
						...
						<li>
							<b>Срок обучения:</b> 256 часов.<br>							
							Выдаваемый документ: диплом о профессиональной переподготовке.<br>
						</li>
						<li>
