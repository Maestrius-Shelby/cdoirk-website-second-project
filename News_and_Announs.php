...
<div id="wrapper" class="wrapper">
			...
			<script type="text/javascript">
			      $(document).ready(function()
			      {
			          $('.mean-toggle').click(function()
			        {
			              ...
			              $('.menu-wrapper5').toggleClass('active')
			        })
			      })
			</script>
		</div>
			...
			<div class="itc-slider-wrapper">
			  <div class="itc-slider-items">
				...
				<div class="itc-slider-item">
					<picture>
					  <source srcset="images/SSUWT/111.jpg" type="image/jpeg" media="(min-width:970px)">
					  <source srcset="images/SSUWT/111.jpg" type="image/jpeg" media="(min-width:750px)">
					  <source srcset="images/SSUWT/112.jpg" type="image/jpeg" media="(max-width:750px)">
					  <img src="images/SSUWT/111.jpg">
					</picture>
    ...
    <section id="content" class="content-section bvi-speech">
        <div id="panels" class="panels">
            <a class="panel blue" data-color="blue">
                <div class="content">
                    <div class="fixed">
                        <h1>Анонсы</h1>
                        <div class="excerpt">
						<?php
    					$table1 = new News($connection, $table = 'announcements');
    					$table1->fetchData($column = "announcements text", $nullText = "анонсы отсутствуют");
    					?>
                        </div>
                    </div>
                </div>
            ...
            <a class="panel green" data-color="green">
                <div class="content">
                    <div class="fixed">
                        <h1>Новости</h1>
                        <div class="excerpt">
						<?php
    					$table2 = new News($connection, $table = 'news');
    					$table2->fetchData($column = "news text", $nullText = "новости отсутствуют");
    					?>
                        </div>
                    </div>
                </div>
            ...
            <a class="panel yellow" data-color="yellow">
                <div class="content">
                    <div class="fixed">
                        <h1>Календарь событий</h1>
                        <div class="excerpt">
						<?php
    					$table3 = new News($connection, $table = 'calendar of events');
						$table3->fetchData($column = "calendar of events text", $nullText = "календарь событий отсутствует");
    					?>
                        </div>
                    </div>
                </div>
...
<script>
var scrollHeight5 = 310; 

window.addEventListener("scroll", function() {
    var menuWrapper5 = document.querySelector(".menu-wrapper5");

    if (window.pageYOffset > scrollHeight5) {
        menuWrapper5.classList.add("sticky");
    } else {
        menuWrapper5.classList.remove("sticky");
    }
});

var menuContainer5 = document.querySelector(".menu-container");
var menuWrapper5 = document.querySelector(".menu-wrapper5");
var menuBottom5 = menuContainer5.offsetTop + menuContainer5.offsetHeight; // Координата нижней границы меню

var isSticky5 = false; // Флаг для отслеживания, прикреплено ли меню

window.addEventListener("scroll", function() {
    if (window.pageYOffset > menuBottom5 && !isSticky5) {
        menuContainer5.classList.add("sticky2");
        menuWrapper5.classList.add("sticky2");
        isSticky5 = true; // Меню прикреплено
    } else if (window.pageYOffset <= menuBottom5 && isSticky5) {
        menuContainer5.classList.remove("sticky2");
        menuWrapper5.classList.remove("sticky2");
        isSticky5 = false; // Меню вернулось на своё место
    }
});
</script>
...
<script src="js/news_and_announs.js"></script>
</body>
</html>
