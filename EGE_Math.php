				...
				<div class="itc-slider-item">
					...
					<div class="container no-padding">
						<div class="hs-caption">
							...
							<br>
								<h4>ПОДГОТОВКА К ЕГЭ ПО ПРЕДМЕТУ: МАТЕМАТИКА</h4>
	...
	<section id="service" class="service">
		...
		<div class="about_welcome_4 wow circle animate__zoomInDown bvi-speech">
			<div class="row">
				...
				<div>
					<p>
						Рабочая программа составлена на основе Методических рекомендаций ФИПИ, анализа типичных ошибок участников ЕГЭ 2023 года по математике, 
						Методических рекомендаций на 2023-2024 учебный год, Демонстрационного варианта КИМ ЕГЭ по математике 2024 года, Кодификатора элементов 
						содержания и Спецификации КИМ. Цель обучения – повышение уровня предметной подготовки обучающихся по математике; успешная сдача ЕГЭ.
					</p>
					<ul>
						<li>
